...
urlpatterns = [
  ...
  path('care/create/', views.CareCreate.as_view(), name='care-create'),
  path('care/<int:pk>/', views.CareDetail.as_view(), name='care-detail'),
  path('care/', views.CareList.as_view(), name='care-index')
]